...
const Prompt = ({
  ...
  return (
    <>
      ...
      // }`}
      >
        <div className="w-full h-ful col-span-4 relative row-span-2 col-start-9 row-start-2">
          <video
            muted
            autoPlay
            loop
            className={`joy-idle absolute w-full scale-[2] top-[65%] opacity-100 ${showJoy && currentFlow.get.action === "WAIT" ? "opacity-100" : ""
              }`}
          >
            <source
          ...
          {/* <video
            ...
            autoPlay
            loop
            className={`joy-wave absolute top-0 ml-[-63px] w-[900px] max-w-none opacity-0 ${showJoy && currentFlow.get.action === "START" ? "opacity-100" : ""
              }`}
          >
            <source
          ...
          {/* <video
            ...
            autoPlay
            loop
            className={`joy-point absolute top-0 ml-[-63px] w-[900px] max-w-none opacity-0 ${showJoy && currentFlow.get.action === "GOTO" ? "opacity-100" : ""
              }`}
          >
            <source
              src='https://frdmqigbelepsdgiecdr.supabase.co/storage/v1/object/public/world1%20assets/joy/Joy-Idle-v2.webm?t=2023-12-01T02%3A47%3A29.340Z'
          ...
          {/* <video
            ...
            autoPlay
            loop
            className={`joy-thinking absolute top-0 ml-[-63px] w-[900px] max-w-none opacity-0 ${showJoy && currentFlow.get.action === "END" ? "opacity-100" : ""
              }`}
          >
            <source
          ...
          {/* <video
            ...
            // autoPlay
            // loop
            className={`joy-thinking absolute top-0 ml-[-63px] w-[900px] max-w-none opacity-0 ${!showJoy && world === 1 && currentFlow.get.action === "GOTO"
              ? "opacity-100"
              : ""
              }`}
          >
          ...
          {/* <video
            ...
            autoPlay
            loop
            className={`joy-thinking absolute top-0 ml-[-63px] w-[900px] max-w-none opacity-0 ${!showJoy && world === 2 && currentFlow.get.action === "GOTO"
              ? "opacity-100"
              : ""
              }`}
          >
          ...
          {/* <video
            ...
            autoPlay
            loop
            className={`joy-thinking absolute top-0 ml-[-63px] w-[900px] max-w-none opacity-0 ${!showJoy && world === 3 && currentFlow.get.action === "GOTO"
              ? "opacity-100"
              : ""
              }`}
          >
          ...
          {/* <video
            ...
            autoPlay
            loop
            className={`joy-thinking absolute top-0 ml-[-63px] w-[900px] max-w-none opacity-0 ${!showJoy && world === 4 && currentFlow.get.action === "GOTO"
              ? "opacity-100"
              : ""
              }`}
          >
        ...
        >
          <div
            className={`prompt-content cursor-pointer absolute top-[30px] right-[100%] mr-[40px] p-[30px] min-w-[470px] opacity-0 translate-x-[100px] ease-in-out ${currentFlow.get.action === "START" ? "!min-w-[430px]" : ""
            ...
            style={{
              ...
              backgroundImage: `url(${currentFlow.get.action === "GOTO" ||
                currentFlow.get.action === "WAIT"
