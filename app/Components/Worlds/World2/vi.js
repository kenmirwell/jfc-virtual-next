export const vi = {
    "2004": {
        ...
        description: `
            ...
            <p>Cùng với tầm nhìn của mình, Tập đoàn Jollibee mua lại thương hiệu quốc tế đầu tiên: Yonghe King. Ngày nay, chuỗi nhà hàng này có hơn 420 cửa hàng ở Trung Quốc và được yêu thích nhờ món đồ uống sữa đậu nành xay tươi ngon và cơm thịt lợn bằm.</p>
    ...
    "2005": {
        title: "Red Ribbon: Những chiếc bánh thơm ngon và mang tính biểu tượng",
        description: `<p><strong>Red Ribbon Bakeshop</strong> gia nhập Tập đoàn Jollibee. Nổi tiếng với các loại bánh kem Black Forest và Dedication thơm ngon, Red Ribbon hiện có mạng lưới cửa hàng gồm hơn 520 cửa hàng ở Philippines và Hoa Kỳ, đồng thời là công ty dẫn đầu thị trường bánh ngọt ở Philippines.</p>`
    },
    "2006": {
        title: "Phục vụ thế giới",
        description: `<p><strong>Jollibee Worldwide Services</strong> (JWS) được thành lập. JWS là đơn vị dịch vụ chung của Tập đoàn Jollibee, với hơn 400 thành viên trong nhóm phục vụ các đơn vị kinh doanh của tập đoàn trên toàn cầu.</p>`
    },
    "2008": {
